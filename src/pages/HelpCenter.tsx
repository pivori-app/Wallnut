      ...
      articles: [
        {
          ...
          content: (
            <div className="space-y-6 text-neutral-dark/80">
              ...
              <h3 className="text-app-lg font-bold text-primary mt-8">1. Expertise indépendante</h3>
              ...
              <h3 className="text-app-lg font-bold text-primary mt-8">2. Application de la décote (LTV)</h3>
              ...
              <div className="p-4 bg-primary/5 rounded-xl border border-primary/10 mt-6">
                ...
                <p className="text-app-sm mt-2">Vous conservez l'intégralité de la plus-value si vous décidez de revendre le bien sur le marché libre à la place de l'option de rachat direct.</p>
              </div>
            </div>
          )
        },
        ...
        },
        {
          ...
          content: (
            <div className="space-y-6 text-neutral-dark/80">
              ...
              <h3 className="text-app-lg font-bold text-primary mt-8">Comment est-elle fixée ?</h3>
      ...
      articles: [
        {
          ...
          content: (
            <div className="space-y-6 text-neutral-dark/80">
              ...
              <h3 className="text-app-lg font-bold text-primary mt-8">Ses interventions :</h3>
              <ul className="space-y-4 my-6">
        ...
        },
        {
          ...
          content: (
            <div className="space-y-6 text-neutral-dark/80">
              ...
              <h3 className="text-app-lg font-bold text-primary mt-8">Critères d'agrément Wallnut :</h3>
            ...
            {!selectedArticle ? (
              ...
              >
                ...
                <div className="text-center mb-16 space-y-8">
                  <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-primary/10 text-primary text-app-xs font-bold uppercase tracking-widest leading-none">
                    <LifeBuoy size={14} /> Centre d'aide Institutionnel
                  </div>
                  <h1 className="text-app-2xl sm:text-app-3xl lg:text-6xl font-display font-bold text-primary">Comment pouvons-nous <span className="text-secondary">vous aider ?</span></h1>
                    ...
                    >
                      <div className="flex items-start gap-6">
                        ...
                        <div className="flex-1 space-y-4">
                          <h3 className="text-app-xl font-display font-bold text-primary">{cat.title}</h3>
                            ...
                            {cat.articles.map((art, aIdx) => (
                              <li key={aIdx}>
                                <button 
                                  ...
                                  className="w-full flex items-center justify-between text-left text-app-sm font-semibold text-primary/70 hover:text-secondary transition-colors group/link p-3 -mx-3 rounded-xl hover:bg-white"
                                >
                                  {art.title}
                ...
                <div className="bg-primary rounded-[3rem] p-12 lg:p-20 text-white flex flex-col md:flex-row items-center justify-between gap-12 relative overflow-hidden">
                  ...
                  <div className="relative z-10 space-y-4 text-center md:text-left">
                    <h2 className="text-app-xl md:text-app-2xl lg:text-app-3xl font-display font-bold text-white">Toujours des questions ?</h2>
                    <p className="text-white/60 text-app-md max-w-lg">Notre équipe d'experts juridiques et financiers est disponible pour vous accompagner personnellement dans l'étude de votre projet.</p>
                  </div>
              ...
              >
                <button 
                  ...
                  className="inline-flex items-center gap-2 px-6 py-3 rounded-xl bg-white border border-slate-200 text-app-sm font-bold text-primary hover:bg-slate-50 transition-all mb-8 shadow-sm group"
                >
                ...
                <div className="glass p-10 lg:p-16 rounded-[3rem] border border-black/5 shadow-2xl relative overflow-hidden">
                  ...
                  <div className="inline-flex items-center gap-2 text-secondary font-bold text-app-sm mb-6 uppercase tracking-wider">
                    {selectedArticle.category}
                  </div>
                  
                  <h1 className="text-app-xl md:text-app-2xl lg:text-app-3xl font-display font-bold text-primary mb-10 leading-tight">
                ...
                <div className="mt-12 flex items-center justify-between p-8 bg-white rounded-[2rem] border border-slate-200 shadow-sm">
                  <div className="space-y-1">
                    ...
                    <p className="text-app-sm text-neutral-dark/60">Notre équipe juridique met à jour le contenu régulièrement.</p>
                  </div>
                ...
                {selectedArticle && (
                  <div className="mt-16">
                    <h3 className="text-app-xl font-display font-bold text-primary mb-6">Dans la même catégorie</h3>
                        ...
                        .map((art, idx) => (
                          ...
                          >
                            <div className="glass h-full p-6 rounded-3xl border border-slate-200 hover:border-secondary/30 hover:shadow-xl transition-all group">
                              ...
                              <p className="text-app-sm text-neutral-dark/60 line-clamp-3">
                              ...
                              <div className="mt-6 flex items-center gap-2 text-app-sm font-bold text-secondary">
