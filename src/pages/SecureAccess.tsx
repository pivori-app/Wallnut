    ...
    return (
      <div className="min-h-screen bg-slate-50 dark:bg-slate-950 flex flex-col items-center justify-center p-6">
        <div className="w-full max-w-md bg-white dark:bg-slate-900 border border-red-200 dark:border-red-500/20 p-8 rounded-3xl shadow-2xl text-center">
           ...
           <h2 className="text-xl font-black text-neutral-800 dark:text-white mb-2">Lien Expiré ou Invalide</h2>
           <p className="text-neutral-600 dark:text-neutral-300 dark:text-neutral-500 dark:text-neutral-400 text-sm mb-6">
    ...
    return (
      <div className="min-h-screen bg-slate-50 dark:bg-slate-950 flex flex-col items-center justify-center p-6 relative">
        ...
        <div className="w-full max-w-md bg-white dark:bg-slate-900 border border-gray-200 dark:border-white/10 p-8 rounded-3xl shadow-2xl">
           ...
           <h2 className="text-xl font-black text-neutral-800 dark:text-white text-center mb-2">Accès Sécurisé</h2>
           <p className="text-neutral-600 dark:text-neutral-300 dark:text-neutral-500 dark:text-neutral-400 text-sm text-center mb-8">
    ...
    <div className="min-h-screen bg-slate-50 dark:bg-slate-950 flex flex-col p-6">
       ...
       <div className="w-full max-w-4xl mx-auto flex-1">
         <div className="flex items-center justify-between mb-8">
           <div>
             <h1 className="text-2xl font-black text-neutral-800 dark:text-white">Dossier : {agrafeData?.templateType || 'Standard'}</h1>
             <p className="text-neutral-600 dark:text-neutral-300 dark:text-neutral-500 dark:text-neutral-400 text-sm mt-1">Partagé par le propriétaire du document. Expire dans 7 jours.</p>
           </div>
           ...
           {agrafeData?.documents?.map((doc: any, idx: number) => (
             <div key={idx} className="bg-white dark:bg-slate-900 border border-gray-200 dark:border-white/10 p-5 rounded-2xl flex items-center justify-between group hover:border-primary dark:hover:border-primary transition-colors">
               <div className="flex items-center gap-4">
                  <div className="w-12 h-12 bg-gray-100 dark:bg-black/30 rounded-xl flex items-center justify-center text-neutral-500 dark:text-neutral-400 group-hover:text-primary transition-colors">
                    <FileText size={24} />
                  </div>
                  <div>
                    <h3 className="font-bold text-neutral-800 dark:text-white">{doc.name || 'Document classifié'}</h3>
                    <p className="text-xs font-medium text-neutral-600 dark:text-neutral-300 mt-1">Classification certifiée • 1.2 MB</p>
                  </div>
               </div>
               <button className="p-2 text-neutral-500 dark:text-neutral-400 hover:text-primary transition-colors">
                 <Download size={20} />
               </button>
             </div>
           ))}
