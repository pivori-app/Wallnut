    ...
    <main className="pt-32 pb-20">
      <div className="max-w-4xl mx-auto px-4">
        <header className="mb-16 text-center space-y-4">
          ...
          <h1 className="text-app-3xl lg:text-6xl font-display font-bold text-primary">{title}</h1>
          <p className="text-neutral-dark/40 text-app-sm italic">Dernière mise à jour : 25 Avril 2026</p>
        </header>
