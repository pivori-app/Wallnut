  ...
  return (
    <div className="space-y-6">
      <div className="bg-white rounded-2xl p-6 shadow-sm border border-slate-100 relative">
        <h2 className="text-app-lg font-bold text-primary mb-4 flex items-center gap-2">
          <Shield className="text-secondary" /> 
          Sécurité Avancée (Architecture CIAM)
        </h2>
        <p className="text-app-sm text-neutral-dark/70 mb-8 border-l-4 border-secondary pl-3 bg-secondary/5 py-2 rounded-r">
        ...
        <div className="space-y-6">
            ...
            <div className="flex flex-col sm:flex-row sm:items-start justify-between gap-4">
              <div className="flex gap-4">
                ...
                <div>
                  ...
                  <p className="text-app-sm text-neutral-dark/70 mt-1 max-w-md">
          ...
          <div className="border border-slate-200 rounded-xl p-5">
            <div className="flex flex-col sm:flex-row sm:items-start justify-between gap-4">
              ...
              <button 
                ...
                disabled={mfaEnabled}
                className="px-4 py-2 border border-slate-300 text-primary text-app-sm font-semibold rounded-lg hover:bg-slate-50 transition-colors shrink-0 disabled:opacity-50"
              >
            ...
            <div className="flex flex-col sm:flex-row sm:items-start justify-between gap-4">
              <div className="flex gap-4">
                ...
                <div>
                  ...
                  <p className="text-app-sm text-blue-800/80 mt-1 max-w-md">
              ...
              <button 
                ...
                className="px-4 py-2 bg-blue-600 text-white text-app-sm font-semibold rounded-lg hover:bg-blue-700 transition-colors shrink-0 disabled:opacity-50"
              >
          ...
          <div className="border-2 border-secondary/20 bg-gradient-to-br from-secondary/5 to-transparent rounded-xl p-6 relative overflow-hidden">
            ...
            <div className="relative z-10">
              ...
              <div className="space-y-6">
                <div>
                  <h4 className="text-app-sm font-bold text-primary uppercase tracking-wider mb-3 flex items-center gap-2">
                    <span className="w-2 h-2 rounded-full bg-secondary"></span> 
                    Court-terme (0-6 mois)
                  </h4>
                  <ul className="space-y-2 text-app-sm text-neutral-dark/80 ml-4 border-l-2 border-secondary/30 pl-4">
                ...
                <div>
                  ...
                  <ul className="space-y-2 text-app-sm text-neutral-dark/80 ml-4 border-l-2 border-blue-500/30 pl-4">
                    <li className="flex items-start gap-2">
